  ...
  return (
    <form action={onSubmit}>
      <div className="mt-10 flex items-center justify-center gap-x-6">
        <input
          className="rounded-md bg-gray-50 dark:bg-gray-950 px-3.5 py-2.5 text-sm font-normal text-black dark:text-white shadow-sm hover:bg-gray-100 dark:hover:bg-gray-900 outline outline-2 outline-offset-2 outline-gray-100 dark:outline-gray-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
          type="text"
          name="brand"
